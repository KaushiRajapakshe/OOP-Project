	...
	<div class="container">
		...
		<form method="post" action="updateProcessPatientHistory">
			...
			<input type="hidden" name="patientHistoryID"
				value="<%=resultSet.getString("patientHistoryID")%>"> <br />
			Patient History ID <input type="text" name="patientHistoryID"
				value="<%=resultSet.getString("patientHistoryID")%>"> <br />
			First name style><input type="text" name="firstname"
				value="<%=resultSet.getString("firstname")%>"> Last name <input
				type="text" name="lastname"
				value="<%=resultSet.getString("lastname")%>"> Gender <input
				type="text" name="gender" value="<%=resultSet.getString("gender")%>">
			<br /> Age <input type="text" name="age"
				value="<%=resultSet.getString("age")%>"> <br /> Blood Type
			<input type="text" name="bloodtype"
				value="<%=resultSet.getString("bloodtype")%>"> <br />
			Allergies <input type="text" name="allergies"
				value="<%=resultSet.getString("allergies")%>"> <br />
			Treatment Details
