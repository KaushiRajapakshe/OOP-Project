	...
	<div class="container">
		...
		<table align="center" cellpadding="15" cellspacing="5" border="1">
			...
			<tr>
				...
				<td><b><a href="#">Delete Records</a></b></td>
			...
			<tr>
				...
				<td><a
					href="adminUpdatePatientHistory.jsp?patientHistoryID=<%=resultset.getString("patientHistoryID")%>">Update</a></td>
				<td><a
					href="DeletePatientHistory.jsp?patientHistoryID=<%=resultset.getString("patientHistoryID")%>">Delete</a></td>
			</tr>
